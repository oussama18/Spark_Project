...
object spark1 {
  def main(args: Array[String]): Unit = {
    ...
    val sparkConf = new SparkConf().setAppName("Projet Spark Titanic").setMaster("local[*]")
    ...
    // Print out a copy of the parameters used by Random Forest
    ...
    println("traindScore:  " + evaluator.evaluate(crossValidatorModel.transform(trainDF)).toString)
    ...
    println("testScore:  " + evaluator.evaluate(results))
